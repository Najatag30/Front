...
export function HistorySection({
  ...
  setSize,
   ...
   console.log("HistorySection - history:", history);
  console.log("HistorySection - page/size:", page, size, "totalPages:", totalPages);
              ...
              <div className="mb-8 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-100 shadow-md">
                ...
                <div className="flex flex-wrap items-end gap-4">
                  <div className="transform transition-all duration-300 hover:scale-105">
                    <Label htmlFor="filter-date" className="block mb-1 text-sm font-medium text-gray-700 flex items-center">
                  ...
                  <div className="transform transition-all duration-300 hover:scale-105">
                    <Label htmlFor="filter-from-time" className="block mb-1 text-sm font-medium text-gray-700 flex items-center">
                  ...
                  <div className="transform transition-all duration-300 hover:scale-105">
                    <Label htmlFor="filter-to-time" className="block mb-1 text-sm font-medium text-gray-700 flex items-center">
                      <Clock className="w-4 h-4 mr-1 text-[#F55B3B]" />
                      Heure fin
                    </Label>
                    <input
  ...
  {log.bic ?? <span className="text-gray-400 italic">N/A</span>}
</TableCell>
                    ...
                    {history.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={6} className="text-center py-12">
                          ...
                          <p className="text-gray-500 text-lg">Aucune opération enregistrée</p>
                        </TableCell>
                      </TableRow>
                    )}
                  </TableBody>
              ...
              {history.length > 0 && (
                <div className="flex flex-wrap justify-between items-center mt-4 gap-2">
                  ...
                  <label htmlFor="page-size-select" className="ml-4 text-sm text-gray-600">Taille :</label>
                  <select
                    id="page-size-select"
                    value={size}
